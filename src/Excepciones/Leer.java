...
public class Leer
{
	...
	/*
	 * Este merodo devuelve la cadena introducida por tacladp
	 */
	  ...
	  public static String dato()
	  {
	    ...
	    try
	    {
	      ...
	      /*
	       * La clase InputStreamREader es un clase puente que convierte un flujo de bytes en una cadena de caracteres
